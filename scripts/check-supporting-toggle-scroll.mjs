...
assert.match(source, /isPrimaryEvidence\(event\) \|\| event\.track === 'tech'/, "기본 시간축은 출처 등급과 무관하게 기술 이벤트를 남겨 시장·기술 두 축을 유지해야 한다");
assert.match(source, /공시 핵심 근거와 기술 이벤트/, "기본 화면의 이벤트 수 설명은 기술 이벤트가 포함됨을 밝혀야 한다");
