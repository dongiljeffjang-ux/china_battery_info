...
assert.match(lib, /import \{ metricTable, selectTimelineEvidence \} from "\.\/timeline-report\.js"/);
...
assert.match(lib, /selectReportPolicies\(policies, \[\.\.\.eventsA, \.\.\.eventsB\]\)/, "비교 리포트는 공통 정책을 대표 항목으로 압축한다");
