...
export async function searchKnowledge({ question, companyId = null, limit = MATCH_COUNT, includeUnverified = false }) {
  ...
  const requiredGroups = companyId ? [] : questionCompanyGroups(question);
  ...
  const ordered = collapseByArticle(demoteUnrelatedCompanies(fused, requiredTerms, requiredGroups));
