...
const DISCLOSURE_NOISE = /피보증|被担保|보증\s*(?:잔액|대상|한도|금액)|担保余额|고부채|부채비율|자산부채율|모집자금\s*(?:전용)?계좌\s*잔액|募集资金.*(?:专户|账户).*余额|关联交易|특수관계자|관계기업|감사(?:의견|보수)|审计意见|임원\s*보수|董事薪酬|배당|현금배당|주당배당|所得税|이연법인세|정부보조금|소송충당|대손충당|매출채권|미수금|应收账款|차입금|유동부채|비유동부채/iu;
