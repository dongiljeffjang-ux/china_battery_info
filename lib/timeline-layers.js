...
export const MARKET_LAYERS = [
  { key: "supply-performance", label_ko: "수급·사업성과" },
...
export const LAYER_PROMPT_GUIDE = [
  ...
  "supply-performance에는 출하·판매량·생산량·가동률·점유율·제품 믹스·판가·원가·마진처럼 사업 흐름을 설명하는 지표만 넣는다. 단순 매출·영업이익·순이익 반복과 보증·부채·채권·특수관계자 거래·감사·배당 같은 공시 부속정보는 시계열 이벤트로 만들지 않는다.",
