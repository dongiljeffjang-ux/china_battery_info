...
import { TRACKED_COMPANIES, SELECTION_BASIS, buildSearchGroups, plannedSearchRequests, searchProviderPrompt, searchInstructions } from "./china-sources.js";
  ...
  return {
    ...
    stages: [
      ...
      },
      {
        ...
        prompts: [{ name: "함의 종합", provider: "openai", text: REPORT_SYNTHESIS_PROMPT }],
      },
    ],
