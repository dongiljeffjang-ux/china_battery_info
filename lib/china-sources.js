...
export const COMPANIES = [
  { id: "catl", name_ko: "닝더스다이(CATL)", name_zh: "宁德时代", name_en: "Contemporary Amperex Technology", type_tags: ["cell"], priority: 1, aliases: ["宁德时代", "CATL", "Contemporary Amperex Technology"], cninfo: { column: "szse", query: "宁德时代" } },
  { id: "byd", name_ko: "비야디(BYD)", name_zh: "比亚迪", name_en: "BYD", type_tags: ["cell"], priority: 2, aliases: ["比亚迪", "BYD", "刀片电池", "Blade Battery"], cninfo: { column: "szse", query: "比亚迪" } },
  { id: "eve-energy", name_ko: "이브에너지(EVE Energy)", name_zh: "亿纬锂能", name_en: "EVE Energy", type_tags: ["cell"], priority: 5, aliases: ["亿纬锂能", "EVE Energy"], cninfo: { column: "szse", query: "亿纬锂能" } },
  { id: "calb", name_ko: "중촹신항(CALB)", name_zh: "中创新航", name_en: "CALB", type_tags: ["cell"], priority: 3, aliases: ["中创新航", "CALB"], cninfo: { column: "szse", query: "中创新航" } },
  { id: "gotion", name_ko: "궈쉬안하이테크(Gotion)", name_zh: "国轩高科", name_en: "Gotion High-tech", type_tags: ["cell"], priority: 4, aliases: ["国轩高科", "Gotion", "Gotion High-tech"], cninfo: { column: "szse", query: "国轩高科" } },
  { id: "sunwoda", name_ko: "신왕다(Sunwoda)", name_zh: "欣旺达", name_en: "Sunwoda", type_tags: ["cell"], priority: 7, aliases: ["欣旺达", "Sunwoda"], cninfo: { column: "szse", query: "欣旺达" } },
  { id: "hithium", name_ko: "Hithium", name_zh: "海辰储能", name_en: "Hithium", type_tags: ["cell"], priority: null, aliases: ["海辰储能", "Hithium"] },
  { id: "rept", name_ko: "REPT BATTERO", name_zh: "瑞浦兰钧", name_en: "REPT BATTERO", type_tags: ["cell"], priority: null, aliases: ["瑞浦兰钧", "REPT", "REPT BATTERO"] },
  { id: "svolt", name_ko: "SVOLT", name_zh: "蜂巢能源", name_en: "SVOLT", type_tags: ["cell"], priority: 6, aliases: ["蜂巢能源", "SVOLT"] },
  { id: "farasis", name_ko: "Farasis Energy", name_zh: "孚能科技", name_en: "Farasis Energy", type_tags: ["cell"], priority: null, aliases: ["孚能科技", "Farasis"], cninfo: { column: "sse", query: "孚能科技" } },
  { id: "ronbay", name_ko: "룽바이(Ronbay)", name_zh: "容百科技", name_en: "Ronbay", type_tags: ["cathode", "cathode_ncm"], priority: 2, aliases: ["容百科技", "Ronbay", "Ningbo Ronbay"], cninfo: { column: "sse", query: "容百科技" } },
  { id: "hunan-yuneng", name_ko: "후난위넝", name_zh: "湖南裕能", name_en: "Hunan Yuneng", type_tags: ["cathode", "cathode_lfp"], priority: 1, aliases: ["湖南裕能", "Hunan Yuneng"], cninfo: { column: "szse", query: "湖南裕能" } },
  { id: "dynanonic", name_ko: "Dynanonic", name_zh: "德方纳米", name_en: "Dynanonic", type_tags: ["cathode", "cathode_lfp"], priority: 3, aliases: ["德方纳米", "Dynanonic"], cninfo: { column: "szse", query: "德方纳米" } },
  { id: "xtc-new-energy", name_ko: "XTC New Energy", name_zh: "厦钨新能", name_en: "XTC New Energy", type_tags: ["cathode", "cathode_ncm"], priority: null, aliases: ["厦钨新能", "XTC New Energy"], cninfo: { column: "sse", query: "厦钨新能" } },
  { id: "easpring", name_ko: "Easpring", name_zh: "当升科技", name_en: "Easpring", type_tags: ["cathode", "cathode_ncm"], priority: null, aliases: ["当升科技", "Easpring"], cninfo: { column: "szse", query: "当升科技" } },
  { id: "zhenhua-new-material", name_ko: "Zhenhua New Material", name_zh: "振华新材", name_en: "Zhenhua New Material", type_tags: ["cathode", "cathode_ncm"], priority: null, aliases: ["振华新材", "Zhenhua New Material"], cninfo: { column: "sse", query: "振华新材" } },
  { id: "changyuan-lico", name_ko: "Changyuan Lico", name_zh: "长远锂科", name_en: "Changyuan Lico", type_tags: ["cathode", "cathode_ncm"], priority: null, aliases: ["长远锂科", "Changyuan Lico"], cninfo: { column: "sse", query: "长远锂科" } },
  { id: "wanrun-new-energy", name_ko: "Wanrun New Energy", name_zh: "万润新能", name_en: "Wanrun New Energy", type_tags: ["cathode", "cathode_lfp"], priority: 2, aliases: ["万润新能", "Wanrun New Energy"], cninfo: { column: "sse", query: "万润新能" } },
  { id: "lopal", name_ko: "Lopal Tech", name_zh: "龙蟠科技", name_en: "Lopal Tech", type_tags: ["cathode", "cathode_lfp"], priority: 5, aliases: ["龙蟠科技", "Lopal"], cninfo: { column: "sse", query: "龙蟠科技" } },
  { id: "cnrg", name_ko: "CNGR", name_zh: "中伟股份", name_en: "CNGR", type_tags: ["cathode"], priority: null, aliases: ["中伟股份", "CNGR"], cninfo: { column: "szse", query: "中伟股份" } },
  ...
  { id: "btr", name_ko: "BTR", name_zh: "贝特瑞", name_en: "BTR", type_tags: ["anode"], priority: 1, aliases: ["贝特瑞", "BTR", "Beijing BTR"], cninfo: { column: "neeq", query: "贝特瑞" } },
  { id: "shanshan", name_ko: "샨샨", name_zh: "杉杉股份", name_en: "Shanshan", type_tags: ["anode"], priority: 2, aliases: ["杉杉股份", "Shanshan"], cninfo: { column: "sse", query: "杉杉股份" } },
  { id: "putailai", name_ko: "푸타이라이", name_zh: "璞泰来", name_en: "Putailai", type_tags: ["anode"], priority: 6, aliases: ["璞泰来", "Putailai", "Zichen"], cninfo: { column: "sse", query: "璞泰来" } },
  { id: "zhongke-electric", name_ko: "중커전기", name_zh: "中科电气", name_en: "Zhongke Electric", type_tags: ["anode"], priority: 3, aliases: ["中科电气", "Zhongke Electric", "Zhongke Xingcheng"], cninfo: { column: "szse", query: "中科电气" } },
  { id: "shangtai-technology", name_ko: "Shangtai Technology", name_zh: "尚太科技", name_en: "Shangtai Technology", type_tags: ["anode"], priority: 4, aliases: ["尚太科技", "Shangtai"], cninfo: { column: "szse", query: "尚太科技" } },
  { id: "xiangfenghua", name_ko: "Xiangfenghua", name_zh: "翔丰华", name_en: "Xiangfenghua", type_tags: ["anode"], priority: null, aliases: ["翔丰华", "Xiangfenghua"], cninfo: { column: "szse", query: "翔丰华" } },
  ...
  const results = await Promise.all(groups.map(async (group) => {
    try {
      const names = group.ids.map((id) => {
        ...
        return `${company.name_ko} [${company.name_zh}(${company.name_en})${groupEntities ? `; ${groupEntities}` : ""}]`;
      }).join("、");
      const result = await createJsonResponse({
        name: "china_battery_news_candidates", schema, webSearch: true,
        instructions: `중국 이차전지 산업 뉴스 리서처다. 웹 검색을 이용한다. ${providerInstructions} 검색 결과에 실제로 제시된 원문 기사 URL만 반환한다. URL·제목·매체·날짜를 추정하거나 만들어내지 않는다. 광고, 자동차 소비자 리뷰, 주가 단신은 제외한다. 중국어/영어 원문 모두 가능하다. 대괄호 안은 서비스의 한국어 표준명과 중국어·영어 검색 별칭이다. 그룹 회사는 모회사뿐 아니라 명시된 주요 계열사 관련 기사도 찾되, 관계가 불명확한 동명사는 포함하지 않는다.`,
        input: `${since}부터 ${until}까지 ${group.label} 그룹/기업(${names})의 사업·생산·증설·수주·고객·기술·재무·해외 전략과 직접 관련된 기사 후보를 최대 12건 찾으세요. 각 기사에는 제목, 원문 URL, 원 매체명, 발행일(모르면 null), 검색 결과에 보이는 1~2문장 요약을 반환하세요.`,
        provider
      });
