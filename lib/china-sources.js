...
export const COMPANIES = [
  { id: "catl", name_ko: "닝더스다이(CATL)", name_zh: "宁德时代", name_en: "Contemporary Amperex Technology", type_tags: ["cell"], aliases: ["宁德时代", "CATL", "Contemporary Amperex Technology", "邦普循环", "广东邦普", "Brunp", "Brunp Recycling"], group: { id: "catl-group", name_ko: "닝더스다이 그룹", members_ko: ["닝더스다이(CATL)", "브럼프 리사이클링(BRUNP)"], search_entities: ["宁德时代(CATL)", "广东邦普循环科技(Brunp Recycling)"] }, cninfo: { column: "szse", query: "宁德时代" } },
  { id: "byd", name_ko: "비야디(BYD)", name_zh: "比亚迪", name_en: "BYD", type_tags: ["cell"], aliases: ["比亚迪", "BYD", "刀片电池", "Blade Battery"], cninfo: { column: "szse", query: "比亚迪" } },
  { id: "eve-energy", name_ko: "이브에너지(EVE Energy)", name_zh: "亿纬锂能", name_en: "EVE Energy", type_tags: ["cell"], aliases: ["亿纬锂能", "EVE Energy"], cninfo: { column: "szse", query: "亿纬锂能" } },
  { id: "calb", name_ko: "중촹신항(CALB)", name_zh: "中创新航", name_en: "CALB", type_tags: ["cell"], aliases: ["中创新航", "CALB"], cninfo: { column: "szse", query: "中创新航" } },
  { id: "gotion", name_ko: "궈쉬안하이테크(Gotion)", name_zh: "国轩高科", name_en: "Gotion High-tech", type_tags: ["cell"], aliases: ["国轩高科", "Gotion", "Gotion High-tech"], cninfo: { column: "szse", query: "国轩高科" } },
  { id: "sunwoda", name_ko: "신왕다(Sunwoda)", name_zh: "欣旺达", name_en: "Sunwoda", type_tags: ["cell"], aliases: ["欣旺达", "Sunwoda"], cninfo: { column: "szse", query: "欣旺达" } },
  { id: "hithium", name_ko: "Hithium", name_zh: "海辰储能", name_en: "Hithium", type_tags: ["cell"], aliases: ["海辰储能", "Hithium"] },
  { id: "rept", name_ko: "REPT BATTERO", name_zh: "瑞浦兰钧", name_en: "REPT BATTERO", type_tags: ["cell"], aliases: ["瑞浦兰钧", "REPT", "REPT BATTERO"] },
  { id: "svolt", name_ko: "SVOLT", name_zh: "蜂巢能源", name_en: "SVOLT", type_tags: ["cell"], aliases: ["蜂巢能源", "SVOLT"] },
  { id: "farasis", name_ko: "Farasis Energy", name_zh: "孚能科技", name_en: "Farasis Energy", type_tags: ["cell"], aliases: ["孚能科技", "Farasis"], cninfo: { column: "sse", query: "孚能科技" } },
  ...
  { id: "dynanonic", name_ko: "Dynanonic", name_zh: "德方纳米", name_en: "Dynanonic", type_tags: ["cathode"], aliases: ["德方纳米", "Dynanonic"], cninfo: { column: "szse", query: "德方纳米" } },
  { id: "xtc-new-energy", name_ko: "XTC New Energy", name_zh: "厦钨新能", name_en: "XTC New Energy", type_tags: ["cathode"], aliases: ["厦钨新能", "XTC New Energy"], cninfo: { column: "sse", query: "厦钨新能" } },
  { id: "easpring", name_ko: "Easpring", name_zh: "当升科技", name_en: "Easpring", type_tags: ["cathode"], aliases: ["当升科技", "Easpring"], cninfo: { column: "szse", query: "当升科技" } },
  { id: "zhenhua-new-material", name_ko: "Zhenhua New Material", name_zh: "振华新材", name_en: "Zhenhua New Material", type_tags: ["cathode"], aliases: ["振华新材", "Zhenhua New Material"], cninfo: { column: "sse", query: "振华新材" } },
  { id: "changyuan-lico", name_ko: "Changyuan Lico", name_zh: "长远锂科", name_en: "Changyuan Lico", type_tags: ["cathode"], aliases: ["长远锂科", "Changyuan Lico"], cninfo: { column: "sse", query: "长远锂科" } },
  { id: "wanrun-new-energy", name_ko: "Wanrun New Energy", name_zh: "万润新能", name_en: "Wanrun New Energy", type_tags: ["cathode"], aliases: ["万润新能", "Wanrun New Energy"], cninfo: { column: "sse", query: "万润新能" } },
  { id: "lopal", name_ko: "Lopal Tech", name_zh: "龙蟠科技", name_en: "Lopal Tech", type_tags: ["cathode"], aliases: ["龙蟠科技", "Lopal"], cninfo: { column: "sse", query: "龙蟠科技" } },
  { id: "cnrg", name_ko: "CNGR", name_zh: "中伟股份", name_en: "CNGR", type_tags: ["cathode"], aliases: ["中伟股份", "CNGR"], cninfo: { column: "szse", query: "中伟股份" } },
  ...
  { id: "shangtai-technology", name_ko: "Shangtai Technology", name_zh: "尚太科技", name_en: "Shangtai Technology", type_tags: ["anode"], aliases: ["尚太科技", "Shangtai"], cninfo: { column: "szse", query: "尚太科技" } },
  { id: "xiangfenghua", name_ko: "Xiangfenghua", name_zh: "翔丰华", name_en: "Xiangfenghua", type_tags: ["anode"], aliases: ["翔丰华", "Xiangfenghua"], cninfo: { column: "szse", query: "翔丰华" } },
  { id: "kaijin-new-energy", name_ko: "Kaijin New Energy", name_zh: "凯金新能源", name_en: "Kaijin New Energy", type_tags: ["anode"], aliases: ["凯金新能源", "Kaijin"] },
  { id: "kuntian-new-energy", name_ko: "Kuntian New Energy", name_zh: "坤天新能源", name_en: "Kuntian New Energy", type_tags: ["anode"], aliases: ["坤天新能源", "Kuntian"] },
  { id: "carbon-one", name_ko: "Carbon One", name_zh: "碳一新能源", name_en: "Carbon One", type_tags: ["anode"], aliases: ["碳一新能源", "Carbon One"] },
];
  ...
  const results = await Promise.all(groups.map(async (group) => {
    try {
      const names = group.ids.map((id) => {
        ...
        const groupEntities = company.group?.search_entities?.join(" / ");
