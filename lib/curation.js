...
async function pendingWork() {
  ...
  const [facts, concepts, basis, article, headline, report, digest, web, enrich] = await Promise.all([
  ...
  return { facts, concepts, basis, article, headline, report, digest, web, enrich };
}
