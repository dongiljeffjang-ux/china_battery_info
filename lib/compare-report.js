...
const LENGTH_GUIDE =
  ...
  "korea_insight의 point_ko는 두 문장, basis_ko는 한 문장, watch_ko는 두 문장 안으로 쓴다. 개조식으로 끊지 말고 줄글로 쓴다.";
...
const FACT_RULE =
  ...
  "한국 배터리 셀사와 양극재·음극재 소재사에게 이 비교가 갖는 사업적 함의를 쓴다. " +
  ...
  try {
    const verified = await createJsonResponse({
      ...
      instructions:
        ...
        `checked_ko에는 무엇을 확인했는지 한 문장으로 쓴다. ${FACT_RULE} ${LENGTH_GUIDE}`,
