...
const LENGTH_GUIDE =
  ...
  "trajectory.a·b의 market_ko와 technology_ko는 각각 두세 개 항목, comparison의 market_ko·technology_ko·divergence_ko는 각각 두 개 항목으로 쓴다. " +
  "pair_lite의 각 필드는 한두 개 항목, korea_insight의 implication_ko와 basis_ko는 각각 한 개 항목, point_ko는 두세 개 항목으로 쓴다.";
