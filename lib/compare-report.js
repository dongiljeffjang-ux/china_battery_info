...
export async function buildCompareReport({ companyIdA, companyIdB, nameA, nameB, eventsA, eventsB, metricsA = [], metricsB = [], alternativesA = [], alternativesB = [], policies = [], policyLinksA = [], policyLinksB = [], policyStatus = "none", pairContext }) {
