...
export async function buildCompareReport({ companyIdA, companyIdB, nameA, nameB, eventsA, eventsB, metricsA = [], metricsB = [], pairContext }) {
  ...
  const evidence = [
    ...
    serializeMetrics("B", nameB, metricsB), serializeEvents("B", nameB, eventsB), conceptGraphText
  ].filter(Boolean).join("\n\n");
