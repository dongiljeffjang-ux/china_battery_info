...
| T8 | 코드·회귀 완료(09-10). `[单位:千元]` 등 표 끝 꼬리표를 환산에 반영하고 긴 자회사명·소재/제품 매출을 전사 매출에서 제외한다. 운영 교차 대조와 백필 쓰기는 아직 대기 | 운영 Supabase 대조 | 09-10 |
...
| T11 | ✅ 회사 스코핑(09-09) + 밸류체인 회사 범위(C2, 09-10). `type_tags` 집합을 셀사·양극재사·음극재사 필수 OR 그룹으로 연결하고 주제어 단독 질문은 필터링하지 않는다. 코드·전체 회귀 완료 | 운영 검색 재판정 | 09-10 |
